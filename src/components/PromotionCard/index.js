...
const PromotionCard = ({ id, title, picture, start_at: startAt, end_at: endAt, days = [], dish, clientId, token, loadPromotions, locale }) => {
            ...
            <Card>
                ...
                <CardBody>
                    ...
                    <CardText className='text-center' style={{ fontSize: '1.5rem' }}>
                        <i className='iconsmind-Plates' />{' '} {dish.name}
                    </CardText>
